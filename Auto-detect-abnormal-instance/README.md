...
# 验证模板语法
aws cloudformation validate-template --template-body file://ec2-abnormal-detection-cdk-github.yaml

# 在测试环境部署
aws cloudformation create-stack \
  --stack-name ec2-detection-test \
  --template-body file://ec2-abnormal-detection-cdk-github.yaml \
  --capabilities CAPABILITY_NAMED_IAM \
...
1. 查看 [Issues](https://github.com/your-username/ec2-abnormal-detection/issues) 页面
2. 创建新的 Issue 描述问题
